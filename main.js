...
console.log("direita");}
if(keyPressed == '67'){ newImage("cloud.jpg");
console.log("c");}
if(keyPressed == '68'){ newImage("dark_green.png");
console.log("d");}
if(keyPressed == '71'){ newImage("ground.png");
console.log("g");}
if(keyPressed == '76'){ newImage("light_green.png");
console.log("l");}
if(keyPressed == '82'){ newImage("roof.jpg");
console.log("r");}
if(keyPressed == '84'){ newImage("trunk.jpg");
console.log("t");}
if(keyPressed == '85'){ newImage("unique.png");
console.log("u");}
if(keyPressed == '87'){ newImage("wall.jpg");
console.log("w");}
if(keyPressed == '89'){ newImage("yellow.png");
console.log("y");}}
function up () {
if (playerY>=0)
